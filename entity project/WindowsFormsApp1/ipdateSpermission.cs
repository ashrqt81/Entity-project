...
{
    public partial class ipdateSpermission : Form
    {
        public ipdateSpermission()
        {
            InitializeComponent();
        }

        private void ipdateSpermission_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("لا يوجد اذن متاح");
            }
        }
    }
}
